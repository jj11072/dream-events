              ...
              <div className="flex flex-wrap justify-between md:gap-10 md:flex-nowrap">
                ...
                <div className="flex items-center justify-between w-full md:w-auto">
                  ...
                  <Disclosure.Button
                    ...
                    className="px-2 py-1 ml-auto text-pink-600 rounded-md md:hidden focus:text-blue-500 focus:outline-none dark:text-gray-300 ">
                    <svg
                  ...
                  {rightmenu.map((item, index) => (
                    <Link href={item.href} key={index}>
                      <a
                        ...
                        {item.badge && (
                          <span className="bg-blue-100 text-pink-600 text-xs font-semibold ml-2 px-2 py-0.5 rounded dark:bg-cyan-200 dark:text-pink-800 ">
                            {item.badge}
                          </span>
                        )}
                      </a>
